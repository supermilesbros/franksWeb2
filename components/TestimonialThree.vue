  ...
  <section class="testimonials-three">
    <div class="container">
      <div class="block-title text-center">
        <p class="text-orange">testimonails</p>
        <h3 class="test-header">What people say</h3>
        <div class="leaf">
      ...
      <div class="testimonials-three__carousel thm__owl-carousel light-dots owl-carousel">
        <no-ssr>
          <carousel :autoplay="false" :margin="30" :dots="false" :nav="false" :responsive="{0: {items: 1},640: {items: 2},992: {items: 3},1024: {items: 3}}">
          ...
          <div class="testimonials-three__single">
            ...
            <div class="testimonials-three__info">
              ...
              <h3 class="test-header">Kevin Smith</h3>
              <p class="text-orange">founder</p>
            </div>
          </div>
        </div>
        <div class="item">
          <div class="testimonials-three__single">
            ...
            <div class="testimonials-three__info">
              <img src="/assets/images/testimonials/testimonial-3-img-1.png" alt="">
              <h3 class="test-header">jessica brown</h3>
              <p class="text-orange">founder</p>
            </div>
          </div>
        </div>
        ...
        <div class="item">
          <div class="testimonials-three__single">
            ...
            <div class="testimonials-three__info">
              ...
              <h3 class="test-header">daniyal coper</h3>
              <p class="text-orange">founder</p>
            </div>
          </div>
        </div>
